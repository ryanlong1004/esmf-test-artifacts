build time -- 2022-03-17 01:31:05
...
ESMF_APPSDIR=/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop/apps/appsO/Unicos.intel.64.mpi.default
ESMF_LIBSDIR=/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default
...
ESMF_F90LINKPATHS=-L/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default -L/apps/prod/hpc-stack/intel-19.1.3.304/cray-mpich-8.1.4/netcdf/4.7.4/lib -L/apps/prod/hpc-stack/intel-19.1.3.304/cray-mpich-8.1.4/netcdf/4.7.4/lib 
ESMF_F90ESMFLINKPATHS=-L/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default -Wl,-rpath,/apps/prod/hpc-stack/intel-19.1.3.304/cray-mpich-8.1.4/netcdf/4.7.4/lib -Wl,-rpath,/apps/prod/hpc-stack/intel-19.1.3.304/cray-mpich-8.1.4/netcdf/4.7.4/lib
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default
...
ESMF_CXXCOMPILEPATHS= -I/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop/src/include  -I/apps/prod/hpc-stack/intel-19.1.3.304/cray-mpich-8.1.4/netcdf/4.7.4/include -I/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-fPIC -DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.3.0b09-3-ge20ebbf11d' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpi -DESMF_DIR=/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_POSIXIPC -DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.3.0b09-3-ge20ebbf11d' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpi -DESMF_DIR=/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_POSIXIPC

ESMF_CXXLINKOPTS=-fPIC -lnetcdff -lnetcdff  -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default -L/apps/prod/hpc-stack/intel-19.1.3.304/cray-mpich-8.1.4/netcdf/4.7.4/lib -L/apps/prod/hpc-stack/intel-19.1.3.304/cray-mpich-8.1.4/netcdf/4.7.4/lib -L/pe/intel/compilers_and_libraries_2020.4.304/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default -Wl,-rpath,/apps/prod/hpc-stack/intel-19.1.3.304/cray-mpich-8.1.4/netcdf/4.7.4/lib -Wl,-rpath,/apps/prod/hpc-stack/intel-19.1.3.304/cray-mpich-8.1.4/netcdf/4.7.4/lib
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default
...
ESMF_TRACE_LDPRELOAD=/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop
ESMF_INTERNAL_MPIRUN=/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop/scripts/mpirun.unicos 

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop
# ESMF_OS: Unicos
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
