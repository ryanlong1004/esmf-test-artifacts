build time -- 2022-03-24 06:08:47.635073
...
ESMF_VERSION_STRING_GIT=v8.3.0b10
#----------------------------------------------
...
ESMF_APPSDIR=/glade/scratch/rlong/esmf-testing/gfortran_7.4.0_openmpi_g_develop/apps/appsg/Linux.gfortran.64.openmpi.default
ESMF_LIBSDIR=/glade/scratch/rlong/esmf-testing/gfortran_7.4.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default
...
ESMF_F90COMPILEPATHS=-I/glade/scratch/rlong/esmf-testing/gfortran_7.4.0_openmpi_g_develop/mod/modg/Linux.gfortran.64.openmpi.default -I/glade/scratch/rlong/esmf-testing/gfortran_7.4.0_openmpi_g_develop/src/include -I/glade/u/apps/ch/opt/netcdf/4.7.3/gnu/7.4.0/include -I/glade/u/apps/ch/opt/netcdf/4.7.3/gnu/7.4.0/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.3.0b10' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=openmpi -DESMF_DIR=/glade/scratch/rlong/esmf-testing/gfortran_7.4.0_openmpi_g_develop
...
ESMF_F90LINKPATHS=-L/glade/scratch/rlong/esmf-testing/gfortran_7.4.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default -L/glade/u/apps/ch/opt/netcdf/4.7.3/gnu/7.4.0/lib -L/glade/u/apps/ch/opt/netcdf/4.7.3/gnu/7.4.0/lib -L/glade/u/apps/ch/opt/netcdf/4.7.3/gnu/7.4.0//lib -L/glade/u/apps/ch/opt/gnu/7.4.0/lib/gcc/x86_64-pc-linux-gnu/7.4.0/../../../../lib64/
ESMF_F90ESMFLINKPATHS=-L/glade/scratch/rlong/esmf-testing/gfortran_7.4.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/glade/scratch/rlong/esmf-testing/gfortran_7.4.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.3/gnu/7.4.0/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.3/gnu/7.4.0/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.3/gnu/7.4.0//lib -Wl,-rpath,/glade/u/apps/ch/opt/gnu/7.4.0/lib/gcc/x86_64-pc-linux-gnu/7.4.0/../../../../lib64/
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/rlong/esmf-testing/gfortran_7.4.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default
...
ESMF_CXXCOMPILEPATHS= -I/glade/scratch/rlong/esmf-testing/gfortran_7.4.0_openmpi_g_develop/src/include  -I/glade/u/apps/ch/opt/netcdf/4.7.3/gnu/7.4.0/include -I/glade/scratch/rlong/esmf-testing/gfortran_7.4.0_openmpi_g_develop/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.3.0b10' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=openmpi -DESMF_DIR=/glade/scratch/rlong/esmf-testing/gfortran_7.4.0_openmpi_g_develop -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_SIGUSR2

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -fopenmp
ESMF_CXXLINKPATHS=-L/glade/scratch/rlong/esmf-testing/gfortran_7.4.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default -L/glade/u/apps/ch/opt/netcdf/4.7.3/gnu/7.4.0/lib -L/glade/u/apps/ch/opt/netcdf/4.7.3/gnu/7.4.0/lib -L/glade/u/apps/ch/opt/netcdf/4.7.3/gnu/7.4.0//lib -L/glade/u/apps/ch/opt/gnu/7.4.0/lib/gcc/x86_64-pc-linux-gnu/7.4.0/../../../../lib64/
ESMF_CXXESMFLINKPATHS=-L/glade/scratch/rlong/esmf-testing/gfortran_7.4.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/glade/scratch/rlong/esmf-testing/gfortran_7.4.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.3/gnu/7.4.0/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.3/gnu/7.4.0/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.3/gnu/7.4.0//lib -Wl,-rpath,/glade/u/apps/ch/opt/gnu/7.4.0/lib/gcc/x86_64-pc-linux-gnu/7.4.0/../../../../lib64/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/rlong/esmf-testing/gfortran_7.4.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default
...
ESMF_TRACE_LDPRELOAD=/glade/scratch/rlong/esmf-testing/gfortran_7.4.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/glade/scratch/rlong/esmf-testing/gfortran_7.4.0_openmpi_g_develop
ESMF_INTERNAL_MPIRUN=mpirun 

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /glade/scratch/rlong/esmf-testing/gfortran_7.4.0_openmpi_g_develop
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
