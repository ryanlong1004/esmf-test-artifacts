Fri 18 Mar 01:57:30 UTC 2022
#!/bin/sh -l
#PBS -N test-intel_19.1.3_mpi_g.bat
...
cd /lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_g_jedwards_pio_update2
...
export ESMF_DIR=/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_g_jedwards_pio_update2
...
ssh alogin01 /lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_g_jedwards_pio_update2/runpython.sh 2>&1 | tee python_build.log
