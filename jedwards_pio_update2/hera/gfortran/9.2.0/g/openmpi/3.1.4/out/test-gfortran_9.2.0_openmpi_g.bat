...
export ESMF_DIR=/scratch1/NCEPDEV/stmp2/role.esmfmaint/gfortran_9.2.0_openmpi_g_jedwards_pio_update2
...
ssh hfe06 /scratch1/NCEPDEV/stmp2/role.esmfmaint/gfortran_9.2.0_openmpi_g_jedwards_pio_update2/runpython.sh 2>&1 | tee python_build.log
