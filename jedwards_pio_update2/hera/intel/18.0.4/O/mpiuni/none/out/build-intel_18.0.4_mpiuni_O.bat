...
module load cmake
export ESMF_MPIRUN=/scratch1/NCEPDEV/stmp2/role.esmfmaint/intel_18.0.4_mpiuni_O_jedwards_pio_update2/src/Infrastructure/stubs/mpiuni/mpirun
