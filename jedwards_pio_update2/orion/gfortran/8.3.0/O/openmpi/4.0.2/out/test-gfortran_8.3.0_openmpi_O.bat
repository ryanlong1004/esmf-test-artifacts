...
export ESMF_DIR=/work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_O_jedwards_pio_update2
...
ssh Orion-login-1.HPC.MsState.Edu /work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_O_jedwards_pio_update2/runpython.sh 2>&1 | tee python_build.log
