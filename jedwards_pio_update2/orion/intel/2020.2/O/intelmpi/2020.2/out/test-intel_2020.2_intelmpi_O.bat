...
export ESMF_DIR=/work/noaa/da/mpotts/sandbox/intel_2020.2_intelmpi_O_jedwards_pio_update2
...
ssh Orion-login-1.HPC.MsState.Edu /work/noaa/da/mpotts/sandbox/intel_2020.2_intelmpi_O_jedwards_pio_update2/runpython.sh 2>&1 | tee python_build.log
