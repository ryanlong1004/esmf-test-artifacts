build time -- 2022-03-18 02:48:00
...
ESMF_APPSDIR=/work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_jedwards_pio_update2/apps/appsO/Linux.intel.64.intelmpi.default
ESMF_LIBSDIR=/work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_jedwards_pio_update2/lib/libO/Linux.intel.64.intelmpi.default
...
ESMF_F90COMPILEPATHS=-I/work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_jedwards_pio_update2/mod/modO/Linux.intel.64.intelmpi.default -I/work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_jedwards_pio_update2/src/include -I/apps/intel-2020.2/impi-2020.2/netcdf-4.7.4/include -I/apps/intel-2020.2/impi-2020.2/netcdf-4.7.4/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.3.0b09-102-gabaf3ef' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=intelmpi -DESMF_DIR=/work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_jedwards_pio_update2
...
ESMF_F90LINKPATHS=-L/work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_jedwards_pio_update2/lib/libO/Linux.intel.64.intelmpi.default -L/apps/intel-2020.2/impi-2020.2/netcdf-4.7.4/lib -L/apps/intel-2020.2/impi-2020.2/netcdf-4.7.4/lib 
ESMF_F90ESMFLINKPATHS=-L/work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_jedwards_pio_update2/lib/libO/Linux.intel.64.intelmpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_jedwards_pio_update2/lib/libO/Linux.intel.64.intelmpi.default -Wl,-rpath,/apps/intel-2020.2/impi-2020.2/netcdf-4.7.4/lib -Wl,-rpath,/apps/intel-2020.2/impi-2020.2/netcdf-4.7.4/lib 
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_jedwards_pio_update2/lib/libO/Linux.intel.64.intelmpi.default
...
ESMF_CXXCOMPILEPATHS= -I/work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_jedwards_pio_update2/src/include  -I/apps/intel-2020.2/impi-2020.2/netcdf-4.7.4/include -I/work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_jedwards_pio_update2/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.3.0b09-102-gabaf3ef' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=intelmpi -DESMF_DIR=/work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_jedwards_pio_update2 -D__SDIR__='' -DESMF_CXXSTD=11

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_jedwards_pio_update2/lib/libO/Linux.intel.64.intelmpi.default -L/apps/intel-2020.2/impi-2020.2/netcdf-4.7.4/lib -L/apps/intel-2020.2/impi-2020.2/netcdf-4.7.4/lib -L/apps/intel-2020.2/intel-2020.2/compilers_and_libraries_2020.2.254/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_jedwards_pio_update2/lib/libO/Linux.intel.64.intelmpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_jedwards_pio_update2/lib/libO/Linux.intel.64.intelmpi.default -Wl,-rpath,/apps/intel-2020.2/impi-2020.2/netcdf-4.7.4/lib -Wl,-rpath,/apps/intel-2020.2/impi-2020.2/netcdf-4.7.4/lib  -Wl,-rpath,/apps/intel-2020.2/intel-2020.2/compilers_and_libraries_2020.2.254/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_jedwards_pio_update2/lib/libO/Linux.intel.64.intelmpi.default
...
ESMF_TRACE_LDPRELOAD=/work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_jedwards_pio_update2/lib/libO/Linux.intel.64.intelmpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_jedwards_pio_update2
ESMF_INTERNAL_MPIRUN=mpirun 

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_jedwards_pio_update2
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
